...
starting_surface_ions_per_nm2 = .015;
end_surface_ions_per_nm2 = .001;
PointsAlongGraph = 29;
...
TargetS_ions_per_nm2 = linspace(starting_surface_ions_per_nm2,end_surface_ions_per_nm2,PointsAlongGraph);
...
TargetP_kions = StartingS_kions + StartingN_kions; % in kions
TargetNS_kions = StartingS_kions + StartingN_kions; % in kions
...
parfor k = 1:PointsAlongGraph
       [U{k},storePath{k},RadialSolutions{k}] = Solve_ion_to_ion_V3(TargetP_kions, TargetNS_kions, TargetS_kions(k), R, guessPoint,manyGraphs,verbose);
end
...
figure(106)
    ...
    hold on
    plot(TargetS_ions_per_nm2,UgradV_H2O * 1000 ,'-o','DisplayName', 'water recombination'     ,'LineWidth',2)
